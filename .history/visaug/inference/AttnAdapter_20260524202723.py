    ...
    def forward(
        ...
        if kv_seq_len > SYS_LEN + IMG_LEN and q_len > SYS_LEN + IMG_LEN:
            ...
            if mode == "subspace_pca":
                ...
                # 1. 提取当前层专属的图片 Value 场矩阵: [B, H, 576, D]
